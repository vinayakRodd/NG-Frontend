    ...
    debounce(() => {
      ...
      if (input.length) {
        ...
        if (input.trim() === '') {
          ...
          axios.post("https://ng-backend-s4h4.onrender.comm/api/GetPhysicsCycleSubjects", searchTerm)
          .then(response1 => {
    ...
    <div className='flex transition-all     duration-700 ease-in-out animate-fade-in-slide-up  justify-center gap-2 flex-col mx-auto'>
      ...
      <div className='flex flex-row gap-4' >
        ...
        <div
            ...
            className={`h-10 w-full max-w-xs hover:ring-4 hover:ring-teal-400 mt-[20px] cursor-pointer hover:shadow-custom rounded-full  ${PhysicsCycle ?  'bg-[#20C030]' : 'bg-custom-dark' }`}
        >
        ...
        <div
            ...
            className={`h-10 w-full max-w-xs hover:ring-4 hover:ring-teal-400 mt-[20px] cursor-pointer hover:shadow-custom rounded-full  ${ChemistryCycle ? 'bg-[#20C030]' : 'bg-custom-dark' }`}
        >
      ...
      <div className='flex flex-row gap-4' >
        <div
            onClick={() => SelectSem(1)}
            className={`h-10 w-full max-w-xs hover:ring-4 hover:ring-teal-400 mt-[20px] cursor-pointer hover:shadow-custom rounded-full  ${Sem1 ? 'bg-[#20C030]' : 'bg-custom-dark'}`}
        >
