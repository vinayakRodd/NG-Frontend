...
function ISE2() {
    ...
    const [ISERelatedPdf,setISERelatedPdf] = useState([])
...
<div className='flex flex-col transition-all   duration-100 ease-in-out  animate-fade-in-slide-up'>
    <div className='text-white text-3xl mt-6 flex justify-center'>
      <span className='text-center'>ISE 2nd Year</span>
    </div>
...
{!isFirstRender.current &&  SearchedSubject.current.value.length !== 0 && ISERelatedPdf.length === 0
